...
// • Implement the function: getAllPossibleCoordsRook /// done
// • Implement the function: getAllPossibleCoordsBishop // done 
// • Implement the function: getAllPossibleCoordsKing // done 
// • Implement the function: getAllPossibleCoordsQueen // done
...
function getAllPossibleCoordsRook(pieceCoord) {
    ...
    for (var i = pieceCoord.i + 1; i < gBoard.length; i++) {
        var nextCoordRow = { i: i, j: pieceCoord.j };
        if (isEmptyCell(nextCoordRow)) res.push(nextCoordRow);
        else break;
    }
...
function getAllPossibleCoordsQueen(pieceCoord) {
    var res = [];
    var resDiagonals = getAllPossibleCoordsBishop(pieceCoord);
    var resLines = getAllPossibleCoordsRook(pieceCoord);
    res = resDiagonals.concat(resLines);
...
function getAllPossibleCoordsKnight(pieceCoord) {
    ...
    for (var i = pieceCoord.i - 2; i <= pieceCoord.i + 2; i++) {
        ...
        for (var j = pieceCoord.j - 2; j <= pieceCoord.j + 2; j++) {
            ...
            if (j < 0 || j >= 8) continue;
            if (i === pieceCoord.i && j === pieceCoord.j) continue;
            if ((Math.abs(Math.abs(i) - Math.abs(pieceCoord.i)) + Math.abs(Math.abs(j) - Math.abs(pieceCoord.j)) === 3) && isEmptyCell(coord))  res.push(coord);
